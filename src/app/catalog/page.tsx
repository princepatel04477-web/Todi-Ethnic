...
export const metadata: Metadata = {
  ...
  description: "Browse Todi Creation's design catalog — bridal lehengas, Farsi trails, sider lehengas, and Indo-Western wear. Each design number handcrafted in Surat, Gujarat.",
};
