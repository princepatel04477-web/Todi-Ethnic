...
export const metadata: Metadata = {
  title: "Farsi Lengha Collection | Todi Creation",
  description: "Browse Todi Creation's elegant Farsi Lengha trail collections, manufactured with graceful flares and heritage borders.",
};

export default async function FarsiPage() {
  const products = await fetchProducts({ category: "Farsi Lengha" });

  return (
    <CategoryCollectionPage
      categoryName="Farsi Lengha"
      categorySlug="farsi-lengha"
